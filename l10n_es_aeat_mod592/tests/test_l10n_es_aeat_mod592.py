...
class TestL10nEsAeatMod592(TestL10nEsAeatModBase):
    ...
    def test_model_592(self):
        ...
        # export_csv_acquirer
        csv_res = self.model592.export_csv_acquirer()
        res = self.report_obj._get_report_from_name(csv_res["report_name"])._render_csv(
            self.model592.ids, {}
        )
        res_text = str(res[0])
        ...
        csv_res = self.model592.export_csv_manufacturer()
        res = self.report_obj._get_report_from_name(csv_res["report_name"])._render_csv(
            self.model592.ids, {}
        )
        res_text = str(res[0])
